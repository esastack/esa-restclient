...
public class DefaultRestRequestExecutor implements RestRequestExecutor {
    ...
    public DefaultRestRequestExecutor(HttpClient httpClient, RestClientConfig clientConfig) {
        this.invokeChain = buildInvokeChain(httpClient, clientConfig);
    }
    ...
    private InvokeChain buildInvokeChain(HttpClient httpClient, RestClientConfig clientConfig) {
        InvokeChain invokeChain = new RequestInvoke(httpClient, clientConfig);
