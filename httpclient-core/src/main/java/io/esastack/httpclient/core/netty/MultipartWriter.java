...
import static io.esastack.httpclient.core.util.HttpHeadersUtils.toHttp2Headers;
...
class MultipartWriter extends RequestWriterImpl {
    ...
    @Override
    ChannelFuture writeAndFlush1(io.esastack.httpclient.core.HttpRequest request,
                                 Channel channel,
                                 Context context,
    ...
    private static void encodeAndWrite1(io.esastack.httpclient.core.HttpRequest request,
    ...
    @Override
    ChannelFuture writeAndFlush2(io.esastack.httpclient.core.HttpRequest request,
                                 Channel channel,
                                 Context context,
                                 ChannelPromise headFuture,
    ...
    private void encodeAndWrite2(io.esastack.httpclient.core.HttpRequest request,
                                 Channel channel,
                                 Http2ConnectionHandler handler,
                                 int streamId,
                                 HttpRequest request0,
    ...
    private static HttpPostRequestEncoder buildEncoder(HttpRequest request0,
                                                       io.esastack.httpclient.core.HttpRequest request)
